...
_makeInterrupt21:
	...
	push ds
	mov ax, #0 		; interupts are in lowest memory
	mov ds, ax
	mov si,#0x84		; interupt 0x21 vector (21 * 4 - 84)
...
_launchProgram:
	...
	mov ax,cs		; modify he jmp below to jump to our segment
